...
Below are five existing custom-input comparisons, all at **50 steps, seed=0,
...
#### Example 1: 300 → 222 Sub tokens (CFG=4)
...
#### Example 2: 1178 → 677 Sub tokens (CFG=4)
...
#### Example 3: 713 → 387 Sub tokens (CFG=4)
...
#### Example 4: 1302 → 618 Sub tokens (CFG=2)
...
#### Example 5: 1302 → 618 Sub tokens (CFG=4)
